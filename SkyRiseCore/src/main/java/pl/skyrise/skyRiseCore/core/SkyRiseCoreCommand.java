...
public class SkyRiseCoreCommand implements CommandExecutor {
    ...
    private void handleEnable(CommandSender sender, String[] args) {
        ...
        if (args.length == 1) {
            sender.sendMessage(pl.skyrise.skyRiseCore.utils.ColorUtil.mini("<#459df5>»</#459df5> <yellow>Użycie: <white>/src enable <moduł>"));
            return;
        }
    ...
    private void handleDisable(CommandSender sender, String[] args) {
        ...
        if (args.length == 1) {
            sender.sendMessage(pl.skyrise.skyRiseCore.utils.ColorUtil.mini("<#459df5>»</#459df5> <yellow>Użycie: <white>/src disable <moduł>"));
            return;
        }
    ...
    private void handleReload(CommandSender sender, String[] args) {
        ...
        if (mm.reload(moduleName)) {
            ...
            sender.sendMessage(ColorUtil.mini("<#459df5>» Dostępne: <white>" + String.join(", ", mm.getModuleNames())));
        }
    }
    ...
    private void sendInfo(CommandSender sender) {
        ...
        sender.sendMessage(ColorUtil.mini("<gold><bold>SkyRiseCore <dark_gray>- <#459df5>v" + plugin.getDescription().getVersion()));
        sender.sendMessage(ColorUtil.mini("  <#459df5>Moduły: <white>" + plugin.getModuleManager().getModuleCount()));
        sender.sendMessage(ColorUtil.mini("  <#459df5>Autor: <white>" + String.join(", ", plugin.getDescription().getAuthors())));
        sender.sendMessage(ColorUtil.mini("<dark_gray><strikethrough>                              "));
    }
    ...
    private void sendHelp(CommandSender sender) {
        ...
        sender.sendMessage(ColorUtil.mini("<dark_gray><strikethrough>                              "));
        sender.sendMessage(ColorUtil.mini("  <yellow>/src list              <dark_gray>- <#459df5>Lista modułów"));
        sender.sendMessage(ColorUtil.mini("  <yellow>/src enable <moduł>    <dark_gray>- <#459df5>Włącz moduł"));
        sender.sendMessage(ColorUtil.mini("  <yellow>/src disable <moduł>   <dark_gray>- <#459df5>Wyłącz moduł"));
        sender.sendMessage(ColorUtil.mini("  <yellow>/src reload            <dark_gray>- <#459df5>Przeładuj wszystko"));
        sender.sendMessage(ColorUtil.mini("  <yellow>/src reload <moduł>    <dark_gray>- <#459df5>Przeładuj moduł"));
        sender.sendMessage(ColorUtil.mini("  <yellow>/src version           <dark_gray>- <#459df5>Informacje"));
        sender.sendMessage(ColorUtil.mini("<dark_gray><strikethrough>                              "));
    }
}
