...
public class ArmorWorldCommand implements CommandExecutor {
    ...
    private void handleAdd(CommandSender sender, String[] args) {
        ...
        if (module.addWorld(world)) {
            sender.sendMessage(ColorUtil.mini("<green>» Świat <gold>" + world + "</gold><green> dodany do blokady zbroi."));
        } else {
            sender.sendMessage(ColorUtil.mini("<red>» Świat <gold>" + world + "</gold> jest już zablokowany."));
        }
    }
    ...
    private void handleRemove(CommandSender sender, String[] args) {
        ...
        if (module.removeWorld(world)) {
            ...
            sender.sendMessage(ColorUtil.mini("<red>» Świat <gold>" + world + "</gold> nie jest zablokowany."));
        }
    }
    ...
    private void sendHelp(CommandSender sender) {
        ...
        sender.sendMessage(ColorUtil.mini("<dark_gray><strikethrough>                              "));
        sender.sendMessage(ColorUtil.mini("  <yellow>/aw add <świat>     <dark_gray>- <#459df5>Zablokuj świat"));
        sender.sendMessage(ColorUtil.mini("  <yellow>/aw remove <świat>  <dark_gray>- <#459df5>Odblokuj świat"));
        sender.sendMessage(ColorUtil.mini("  <yellow>/aw list            <dark_gray>- <#459df5>Lista zablokowanych światów"));
        sender.sendMessage(ColorUtil.mini("  <yellow>/aw items           <dark_gray>- <#459df5>Lista zablokowanych przedmiotów"));
        sender.sendMessage(ColorUtil.mini("  <yellow>/aw off             <dark_gray>- <#459df5>Usuń wszystkie blokady"));
        sender.sendMessage(ColorUtil.mini("<dark_gray><strikethrough>                              "));
    }
}
