...
public class BatSpawnModule implements Module {
    ...
    public void onEnable() {
        ...
        this.listener = pl.skyrise.skyRiseCore.core.ModuleSupport.registerListener(plugin, new BatSpawnListener(this, messageCache));
    ...
    private void cacheConfig() {
        ...
        this.denyMessage = config.getConfig().getString("deny-message",
                "<red>» Nietoperze mogą spawnować się tylko poniżej Y {max_y} na blokach stone/deepslate.")
