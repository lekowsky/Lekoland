...
public class FreezeModule implements Module {
    ...
    public void onEnable() {
        ...
        pl.skyrise.skyRiseCore.core.ModuleSupport.bindExecutor(plugin, commands, "freeze", "unfreeze", "setfreeze", "delfreeze");
        ...
        this.listener = pl.skyrise.skyRiseCore.core.ModuleSupport.registerListener(plugin, new FreezeListener(this));
    ...
    public void onDisable() {
        pl.skyrise.skyRiseCore.core.ModuleSupport.bindDisabled(plugin, getName(), "freeze", "unfreeze", "setfreeze", "delfreeze");
        ...
        pl.skyrise.skyRiseCore.core.ModuleSupport.unregisterTabs(tabRegistry, "freeze", "unfreeze", "setfreeze", "delfreeze");
