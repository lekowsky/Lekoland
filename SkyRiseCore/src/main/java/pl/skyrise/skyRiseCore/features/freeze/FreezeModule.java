...
public class FreezeModule implements Module {
    ...
    private void cacheConfig() {
        this.freezeChat = config.getConfig().getString("freeze-chat", "<red>»</red> <red>Zostałeś/aś zamrożony/a! Wejdź pilnie na nasz Discord: <click:open_url:'https://discord.gg/lekoland'><yellow><underlined>discord.gg/lekoland</underlined></yellow></click>");
        this.freezeActionbar = config.getConfig().getString("freeze-actionbar", "<red>»</red> <red>Zostałeś/aś zamrożony/a – wejdź na Discorda!");
    ...
    public boolean unfreezePlayer(UUID uuid) {
        ...
        if (player != null && player.isOnline()) {
            ...
            player.sendMessage(ColorUtil.mini("<green>»</green> <green>Zostałeś/aś odmrożony/a!"));
            player.sendActionBar(ColorUtil.mini("<green>»</green> <green>Odmrożono!"));
        }
        return true;
    }
