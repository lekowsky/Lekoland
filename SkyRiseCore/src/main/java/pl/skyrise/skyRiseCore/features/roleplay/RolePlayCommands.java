...
public class RolePlayCommands implements CommandExecutor {
    ...
    private void handleDo(Player player, String[] args) {
        if (args.length == 0) {
            player.sendMessage(ColorUtil.mini("<#459df5>»</#459df5> <yellow>Użycie: /do <opis otoczenia>"));
            return;
        }
    ...
    private void handleOpis(Player player, String[] args) {
        ...
        if (args.length == 0) {
            player.sendMessage(ColorUtil.mini("<#459df5>»</#459df5> <yellow>Użycie: /opis <treść opisu postaci>"));
            return;
        }
    ...
    private void handleOpis2(Player player, String[] args) {
        ...
        if (args.length == 0) {
            player.sendMessage(ColorUtil.mini("<#459df5>»</#459df5> <yellow>Użycie: /opis2 <opis miejsca stojącego>"));
            return;
        }
        ...
        player.sendMessage(ColorUtil.mini("<#459df5>»</#459df5> <#459df5>Wybierz czas trwania dla opisu miejsca:"));
