...
public class RolePlayModule implements Module {
    ...
    public void onEnable() {
        ...
        this.listener = new RolePlayListener(this);
    ...
    public void onDisable() {
        java.util.Optional.ofNullable(plugin.getCommand("me")).ifPresent(c -> c.setExecutor(null));
        java.util.Optional.ofNullable(plugin.getCommand("do")).ifPresent(c -> c.setExecutor(null));
        java.util.Optional.ofNullable(plugin.getCommand("try")).ifPresent(c -> c.setExecutor(null));
        java.util.Optional.ofNullable(plugin.getCommand("opis")).ifPresent(c -> c.setExecutor(null));
        java.util.Optional.ofNullable(plugin.getCommand("opis2")).ifPresent(c -> c.setExecutor(null));
