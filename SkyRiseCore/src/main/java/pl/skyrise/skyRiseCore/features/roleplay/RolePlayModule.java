...
public class RolePlayModule implements Module {
    ...
    public void onEnable() {
        ...
        pl.skyrise.skyRiseCore.core.ModuleSupport.bindExecutor(plugin, commands, "me", "do", "try", "opis", "opis2");
        ...
        this.listener = pl.skyrise.skyRiseCore.core.ModuleSupport.registerListener(plugin, new RolePlayListener(this));
    ...
    public void onDisable() {
        pl.skyrise.skyRiseCore.core.ModuleSupport.bindDisabled(plugin, getName(), "me", "do", "try", "opis", "opis2");
        ...
        pl.skyrise.skyRiseCore.core.ModuleSupport.unregisterTabs(tabRegistry, "me", "do", "try", "opis", "opis2");
